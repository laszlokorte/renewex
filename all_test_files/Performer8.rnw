    ...
    CH.ifa.draw.cpn.CPNDrawing 40 
        ...
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 326 137 ":perform([moveLeft])" "Helvetica" 0 12 0 REF 50 
            CH.ifa.draw.standard.OffsetLocator 72 -19 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 381 157 "kb:removeBelief([robot],ROBOT)" "Helvetica" 0 12 0 REF 50 
            CH.ifa.draw.standard.OffsetLocator 160 1 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 386 174 "kb:fact(ROBOT@LOCATION),LOC)" "Helvetica" 0 12 0 REF 50 
