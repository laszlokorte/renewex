11 
    de.renew.gui.CPNDrawing 12 
        ...
        de.renew.gui.CPNTextFigure "attributes" "attributes" 4 "TextAlignment" "Int" 0 "FigureWithID" "Int" 121 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 255 199 158 255 21 71 "action DistributePlugin\n  .registerNetInstance(\"D\", this);" "SansSerif" 0 12 0 REF 6 
        ...
        de.renew.gui.CPNTextFigure "attributes" "attributes" 5 "TextAlignment" "Int" 1 "MarkingAppearance" "Int" 2 "FigureWithID" "Int" 130 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 255 199 158 255 106 281 "synchronize" "SansSerif" 1 12 0 REF 19 
            CH.ifa.draw.standard.OffsetLocator -56 0 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   2  
        de.renew.gui.CPNTextFigure "attributes" "attributes" 5 "TextAlignment" "Int" 1 "MarkingAppearance" "Int" 2 "FigureWithID" "Int" 128 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 255 199 158 255 228 269 ":s(root, parent) <- \"D hier, hallo\";\nparent!l(\"von D\");\nroot!l(\"von D\");" "SansSerif" 0 12 0 REF 19 
            CH.ifa.draw.standard.OffsetLocator 126 3 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  NULL  239 125 619 600 