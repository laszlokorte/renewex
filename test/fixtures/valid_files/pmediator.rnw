11 
    de.renew.gui.CPNDrawing 35 
        ...
        de.renew.gui.CPNTextFigure "attributes" "attributes" 4 "TextAlignment" "Int" 1 "FigureWithID" "Int" 599 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 254 254 254 255 259 199 "ko" "SansSerif" 0 12 0 REF 70 
            CH.ifa.draw.standard.OffsetLocator 0 0 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        de.renew.gui.CPNTextFigure "attributes" "attributes" 4 "TextAlignment" "Int" 1 "FigureWithID" "Int" 600 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 255 199 158 255 270 242 "an!s(geld) -> ware;\nko!s(ware) -> geld;" "SansSerif" 0 12 0 REF 23 
