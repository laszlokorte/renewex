    ...
    CH.ifa.draw.cpn.CPNDrawing 47 
        ...
        CH.ifa.draw.cpn.TransitionFigure "no_attributes" 364 496 24 16  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 411 500 ":belief(elist,elist)" "Helvetica" 0 12 0 REF 5 
            CH.ifa.draw.standard.OffsetLocator 79 3 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 404 483 "elist = new fs.FS(\"elist\")" "Helvetica" 0 12 0 REF 5 
        ...
        CH.ifa.draw.cpn.ArcConnection 2 268 138 157 241 NULL 
            ...
            CH.ifa.draw.standard.ChopBoxConnector REF 25  
            CH.ifa.draw.figures.ChopEllipseConnector REF 1   
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 -169 179 "fs.parse(\"[rule GOAL:[atSamePlace OBJ1: #1 OBJ2: #2] SUBGOALS: <[atPlace OBJECT: #1 PLACE: #3] [atPlace OBJECT: #2 PLACE: #3]>]\")\n" "Helvetica" 0 12 0 REF 86 
        ...
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 139 369 ":belief(X,Y)" "Helvetica" 0 12 0 REF 112 
            CH.ifa.draw.standard.OffsetLocator 18 21 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 93 409 "this:belief(R1.at(\"SUBGOALS\"),SGa)" "Helvetica" 0 12 0 REF 112 
            CH.ifa.draw.standard.OffsetLocator 41 61 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 97 392 "R1 = R.unify(new fs.FS(\"GOAL\",X))" "Helvetica" 0 12 0 REF 112 
            CH.ifa.draw.standard.OffsetLocator 40 44 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 90 427 "Y = R1.unify(new fs.FS(\"SUBGOALS\",SGa)).at(\"GOAL\")" "Helvetica" 0 12 0 REF 112 
            CH.ifa.draw.standard.OffsetLocator 88 79 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1   
