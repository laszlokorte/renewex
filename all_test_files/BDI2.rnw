    ...
    CH.ifa.draw.cpn.CPNDrawing 32 
        ...
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 250 234 "e" "Helvetica" 0 12 0 REF 69 
            CH.ifa.draw.standard.OffsetLocator -17 -12 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 98 431 "tfs = new fs.FS().parse(\n\"[E: #1                   \"+\n\" B1: #3                  \"+\n\" B2: #4                  \"+\n\" PLAN: [plan             \"+\n\"        TRIGGER: #1      \"+\n\"        CONTEXT: <#3 #4> \"+\n\"        INTENT: #2]]     \"+\n\" INTENT: #2              \")" "Monospaced" 0 12 0 REF 10 
            CH.ifa.draw.standard.OffsetLocator -70 208 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        CH.ifa.draw.cpn.CPNTextFigure "attributes" "attributes" 2 "FrameColor" "Color" 255 199 158 "FillColor" "Color" 255 199 158 325 431 "mark = new fs.FS()\n.addFeature(\"E\",e)\n.addFeature(\"B1\",b1)\n.addFeature(\"B2\",b2)\n.addFeature(\"PLAN\",plan)" "Helvetica" 0 12 0 REF 10 
            CH.ifa.draw.standard.OffsetLocator 129 178 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
