11 
    de.renew.gui.CPNDrawing 20 
        de.renew.gui.TransitionFigure "attributes" "attributes" 3 "FigureWithID" "Int" 669 "TraceMode" "Boolean" "FALSE" "FillColor" "Color" 119 204 255 255 273 53 24 16 NULL  
        de.renew.gui.CPNTextFigure "attributes" "attributes" 5 "TextAlignment" "Int" 1 "FigureWithID" "Int" 705 "FrameColor" "Color" 255 199 158 255 "TraceMode" "Boolean" "FALSE" "FillColor" "Color" 255 199 158 255 223 34 ":start(activity,_form)" "SansSerif" 0 12 0 REF 1 
        ...
        de.renew.gui.ArcConnection "attributes" "attributes" 1 "FigureWithID" "Int" 721 2 461 181 461 226 NULL 
            ...
            CH.ifa.draw.figures.ChopEllipseConnector 
                de.renew.gui.PlaceFigure "attributes" "attributes" 1 "FigureWithID" "Int" 722 451 225 20 20 NULL    REF 47 
        de.renew.gui.CPNTextFigure "attributes" "attributes" 4 "TextAlignment" "Int" 1 "FigureWithID" "Int" 723 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 254 254 254 255 459 196 "t" "SansSerif" 0 12 0 REF 43 
            CH.ifa.draw.standard.OffsetLocator 0 0 
                CH.ifa.draw.standard.RelativeLocator 0.5 0.5   1  
        de.renew.gui.DeclarationFigure "attributes" "attributes" 4 "TextAlignment" "Int" 0 "FigureWithID" "Int" 720 "FrameColor" "Color" 255 199 158 255 "FillColor" "Color" 255 199 158 255 90 262 "import java.util.*;\nimport ICWorkflow.*;\nimport ICWorkflow.CheckServerStatue;\n" "SansSerif" 0 12 0 NULL NULL 1  NULL  277 885 584 600 